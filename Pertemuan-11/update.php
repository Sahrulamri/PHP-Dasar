    ...
    <div class="container">
        ...
        <form action="" method="post">
            <div class="mb-3">
                ...
                <input type="hidden" class="form-control" id="nrp" name="id" value="<?php echo $mhs["id"]; ?>" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="gambar" name="gambar" value="<?php echo $mhs["gambar"]; ?>" required>
            </div>
